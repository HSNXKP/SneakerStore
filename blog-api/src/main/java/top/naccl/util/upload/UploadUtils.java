...
public class UploadUtils {
	...
	/**
	 *
	 * @param LinuxOrWindow 本地或服务器
	 * @param accessUrl  回显地址
	 * @param fileName  文件名称
	 * @return
	 */
	public static String backUrl(String LinuxOrWindow,String accessUrl,String fileName){
		return LinuxOrWindow + accessUrl +fileName;
	}
}
